...
fn main() {
    ...
    println!("Binary size: {} bytes (vs 10 bytes for 'I love you')", i_love_you.len() * 2);
    ...
    for (i, packet) in i_love_you.iter().enumerate() {
        ...
        println!("    → {} | pitch:{:+3} | bright:{} | grit:{} | boundary:{}",
                 id.to_ascii(), semi, bright, grit, boundary);
    }
